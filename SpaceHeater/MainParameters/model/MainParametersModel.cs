...
namespace SpaceHeater.MainParameters.model;

public partial class MainParametersModel : ObservableObject
{
    ...
    public void SetMass(Element element)
    {
        ...
        if (element is not FamilyInstance) return;
    ...
    public void SetGeomParameters(Element element, bool len, bool width, bool height) 
    {
        ...
        if (unrotateTransform == null) return;
    ...
    private Transform GetFullUnrotationTransform(FamilyInstance fi)
    {
        ...
        var origin = locPoint == null ? XYZ.Zero : locPoint.Point;

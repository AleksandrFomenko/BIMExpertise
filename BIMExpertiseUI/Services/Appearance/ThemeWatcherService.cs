...
namespace BIMExpertiseUI.Services.Appearance;
...
public static class ThemeWatcherService
{
    ...
    public static void Initialize()
    {
        ...
        {
            Source = new Uri("pack://application:,,,/BIMExpertiseUI;component/Styles/App.Resources.xaml", UriKind.Absolute)
        };
    ...
    private static void UpdateDictionary(FrameworkElement frameworkElement)
    {
        var themedResources = frameworkElement.Resources.MergedDictionaries
            .Where(dictionary => dictionary.Source.OriginalString.Contains("BIMExpertiseUI;", StringComparison.OrdinalIgnoreCase))
            .ToArray();

...
{
    public static double GetLength(this BoundingBoxXYZ bb)
    {
        return (bb.Max.X - bb.Min.X) * 304.8;
    }
    public static double GetWidth(this BoundingBoxXYZ bb)
    {
        return (bb.Max.Y - bb.Min.Y) * 304.8;
    }
    public static double GetHeight(this BoundingBoxXYZ bb)
    {
        return (bb.Max.Z - bb.Min.Z) * 304.8;
    }
    public static BoundingBoxXYZ GetRotateBox(this Element element) 
    {
    ...
    private static Transform GetFullUnrotationTransform(FamilyInstance fi)
    {
    ...
    private static BoundingBoxXYZ GetUnionBoundingBox(IEnumerable<Solid> solids, Transform unrotateTransform) 
    {
    ...
    private static void CreateDirectShapeFromSolid(this GeometryObject solid)
    {
